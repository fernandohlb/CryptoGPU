...
#        echo $i
#       for file in sample_files/*; do
#           ./AES/gpu/aes $file>> AES/results_perf/aes_gpu/$(basename $file | cut -d'.' -f1).log 2>&1
...
#
# 	./DES/gpu/des $file $THREADS>> DES/results_perf/des_gpu/$(basename $file | cut -d'.' -f1).log 2>&1
#     done
# done
