...
* AES - ECB
*******************/
int aes_encrypt_ecb(const BYTE in_all[], size_t in_len, BYTE out_all[], const WORD key[], int keysize)
{
...
int aes_decrypt_ecb(const BYTE in_all[], size_t in_len, BYTE out_all[], const WORD key[], int keysize)
{
    BYTE in[AES_BLOCK_SIZE];
    BYTE out[AES_BLOCK_SIZE];
    for(int i = 0; i < in_len; i += 16){
